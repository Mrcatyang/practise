...
var UrlMatcherFactory = (function () {
     ...
     * @param definitionFn A function that is injected before the js runtime starts.
 ...
 *
 * After a new instance of the UIRouter class is created, it should be configured for your js.
 * For instance, js states should be registered with the [[UIRouter.stateRegistry]].
 *
 * ---
 *
...
var StateService = (function () {
     ...
     * #### Example:
     * ```js
     * let js angular.module('js', ['ui.router']);
     *
...
var UrlRouterProvider = (function () {
     ...
     * })
     *
     * js.run(function (MyService, $urlRouter, $http) {
 ...
 * ```
 *
 * When the js state is `js.user` (or any child state),
